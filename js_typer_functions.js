...
function setup_canvas(canvas_id) {
    ...
    width = document.getElementById(canvas_id).clientWidth;
    height = document.getElementById(canvas_id).clientHeight;
    ...
    // draw scale lines and y axis labels
...
function update_graph(canvas_id, words_per_minute, text_iterator, tick_distance) {
...
function character_validate(input_character,mainstring_character,click_event, error_iterator) {


    // check if the characters match
    if (inputCharacter == mainstring_character) {

        // if character being verified against is lower case
        if ( mainstring_character.toLowerCase() == mainstring_character) && (error_iterator == 0) ) {
